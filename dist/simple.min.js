...
for(var s in this.elements.template.sub)i[s]=this.renderElement(s)
i.__call=a+".updateState",this.container.innerHTML=this.htmlTemplate(e,i),this.pState=JSON.parse(JSON.stringify(this.state)),this.didRender()},this.renderElement=function(t){if("object"!=typeof this.elements.template.sub[t])return""
