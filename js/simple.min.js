...
return Math.abs(a)}
var e,i=function(t){return JSON.stringify(t)},a=function(t){return JSON.parse(JSON.stringify(t))}
e=function(e,s){e=i(e).hashCode()
var n="_sj_"+e
if(this.name=e,t[n]=this,this.localStorageKey=n+"_data",this.container=null,this.state={},this.pState={},this.cnf={localStorageWrite:!0,localStorageRead:!0,partialRender:!0,skipEmptyData:!0},"object"==typeof s)for(var r in s)this.cnf[r]=s[r]
...
i=i.replace(s,n)}return i}catch(r){return""}},this.store=function(){this.cnf.localStorageWrite&&"object"==typeof window.localStorage&&window.localStorage.setItem(this.localStorageKey,i(this.state))},this.load=function(){if(this.cnf.localStorageRead&&"object"==typeof window.localStorage){var t=window.localStorage.getItem(this.localStorageKey)
if(!t)return
try{this.state=JSON.parse(t)}catch(e){}}},this.template={main:{},sub:{}},this.data={},this.pData={},this.cache={},this.els=function(t,e,a){if(a._style)return a._style
if(e){var s=i(e),n=i(a.value)
return s.indexOf(n)>=0?"selected":"default"}return"default"},this.eId=function(t){return n+"_el_"+t},this.parseElementData=function(t,e,a,s,r){a||(a={})
var h=this.gc("ped",t)
...
break
case"input":a.onkeyup=p,a.value||(a.value=e)
break
default:s&&(a.onclick=p)}o.selectState="",r>0&&i(e).indexOf(i(a.value))>=0&&("select"==s&&(a.selected="selected",o.selectState='selected="selected"'),("checkbox"==s||"radio"==s)&&(a.checked="checked",o.selectState='checked="checked"'))
...
var e=this.style,s=this.template.main[e],n=this.cache
if(!s)throw new Error("Invalid master template for style: "+e)
var r=t
for(var h in this.template.sub)if(this.cnf.partialRender&&i(this.state[h])==i(this.pState[h])&&"string"==typeof n[h]&&i(this.data[h])==i(this.pData[h])&&!t);else{var l=this.renderElement(h,t)
if(l===!1)n[h]=""
else{var o=this.node(h)
o?"string"==typeof l&&l.length>0&&this.h2n(l,o):"string"==typeof l&&l.length>0&&(n[h]=l,r=!0)}}this.pState=a(this.state),this.pData=a(this.data),r&&(this.container.innerHTML=this.htmlTemplate(s,n).replace(/{[^<>}]+}/gi,"").replace(/{>([^}]+)}/gi,"{$1}"),this._f("drd"))},this.renderElement=function(t,e){if(e=e===!0,"object"!=typeof this.template.sub[t])return!1
var s=this.data[t]||{},n=this.state[t]||"",r=""
if(0==Object.keys(s).length&&this.cnf.skipEmptyData===!0)return!1
var h=this.gc("rde",t)
...
p.map(function(s){d++
var h=a(s),c=o.els(t,n,h),p=o.template.sub[t][c],f=o.parseElementData(t,n,h,l._type,d)
p||(p=o.template.sub[t]["default"])
var u=o.node(t+"_"+d),m=o.htmlTemplate(p,f)
if(u&&o.cnf.partialRender&&!e){var v=d-1,y=i(o.pData[t].element[v]),g=i(o.data[t].element[v])
...
var s={}
t.SimpleApp=function(t,i){return s[t]||(s[t]=new e(t,i)),s[t]},"undefined"!=typeof exports&&(exports.SimpleApp=t.SimpleApp,exports.SimpleEvent=t.SimpleEvent)}(this)
